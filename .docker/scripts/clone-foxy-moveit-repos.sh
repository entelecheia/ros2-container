...
rm -rf src/fcl src/moveit2 src/warehouse_ros src/warehouse_ros_mongo src/srdfdom src/geometric_shapes src/fake_joint
git clone https://github.com/flexible-collision-library/fcl.git src/fcl
